...
function Navbar({ className }) {
  ...
  return (
    <div className={className}>
      ...
      <div
        className={`container flex flex-col justify-center  z-10 pt-[18px] md:pt-[67px] lg:pt-10 ${
          scroll ? " py-0 my-0" : ""
        }`}
      >
        <div
          className={`fixed left-16 right-16 py-[15px] mt-20 md:mt-[46px] mb-[33px] md:mb-0 md:pt-0 md:pb-[13px] lg:pb-[19px] flex justify-end gap-[9px] md:gap-0 md:justify-between border-t-[2px] md:border-t-0 md:border-b-[3px] border-black transition-all ease-linear duration-700 ${
            scroll ? " top-0  mt-0 md:mt-0 pt-1 md:pt-2 " : ""
          }`}
        >
          <NavLink
            to="stream"
      ...
      >
        ...
        <button
          ...
          className="p-5 font-Poppins font-semibold md:text-lg lg:text-[22px] leading-[33px]"
        >
          Выйти{" "}
        </button>
      </div>

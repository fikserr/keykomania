  ...
  return (
    <div>
      <img
        ...
        alt="navBack"
        loading="lazy"
        className="w-full h-[152px] md:h-[318px] lg:h-[377px] object-cover object-top opacity-70"
      />
      ...
      <div className="relative">
        <div className="images  top-0 z-0 w-full">
          <div className="relative">
        ...
        <div className="container mx-auto absolute top-0 left-0 right-0 z-10 pt-[51px] md:pt-[70px] lg:pt-[143px] flex flex-col sm:justify-center sm:items-center">
          ...
          <div className="flex flex-col-reverse items-center md:gap-[25px] lg:gap-[75px] md:flex-row md:justify-between md:items-start lg:items-center pt-[42px] lg:pt-[79px]">
            <article className=" h-full flex flex-col items-center md:justify-between">
          ...
          <BottomText
            className={
              "flex flex-col items-center pt-[77px] md:pt-[112px] lg:pt-[98px]"
            }
            title="keykomania"
